...
#Region " Control Events "
        ...
        Private Sub txtProjectCode_TextChanged(sender As Object, e As System.EventArgs) Handles txtProjectCode.TextChanged            
            ...
            SetDataGridReportTypeInProject()
            SetDataGridReportTypeNotInProject()
        ...
        Private Sub btnAddReportType_Click(sender As Object, e As System.EventArgs) Handles btnAddReportType.Click
            _updateProjectReportType()
            SetDataGridReportTypeByProject()
            SetDataGridReportTypeInProject()
            SetDataGridReportTypeNotInProject()
        End Sub

        Private Sub btnRemoveReportType_Click(sender As Object, e As System.EventArgs) Handles btnRemoveReportType.Click
            _deleteProjectReportType()
            SetDataGridReportTypeByProject()
            SetDataGridReportTypeInProject()
            SetDataGridReportTypeNotInProject()
        End Sub
...
#Region " Timesheet "
        ...
        Protected Sub lvwTimeSheet_ItemCommand(sender As Object, e As System.Web.UI.WebControls.ListViewCommandEventArgs)
            Select Case e.CommandName
                Case "DeleteAdditionalResource"
                    Dim lvwTimeSheet_lblProjectResourceID As Label = CType(e.Item.FindControl("lvwTimeSheet_lblProjectResourceID"), Label)
                    Dim oTS As New Common.BussinessRules.TimeSheet
                    oTS.projectResourceID = lvwTimeSheet_lblProjectResourceID.Text.Trim
                    If oTS.DeleteAdditionalResource() Then
                        TS_ddlMonth_SelectedIndexChanged(Nothing, Nothing)
                    End If
                    oTS.Dispose()
                    oTS = Nothing
            End Select
        ...
        Private Sub TS_btnAddAdditionalResource_Click(sender As Object, e As System.EventArgs) Handles TS_btnAddAdditionalResource.Click
            _insertResource()
        End Sub
#End Region
...
#Region " Service Report "
        ...
        Private Sub SR_grdServiceReportDt_ItemCommand(source As Object, e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles SR_grdServiceReportDt.ItemCommand
            Select Case e.CommandName
                Case "Edit"
                    Dim _SR_lblServiceReportDtID As Label = CType(e.Item.FindControl("SR_lblServiceReportDtID"), Label)
                    SR_txtServiceReportDtID.Text = _SR_lblServiceReportDtID.Text.Trim
                    _openServiceReportDt()
                Case "Delete"
                    Dim _SR_lblServiceReportDtID As Label = CType(e.Item.FindControl("SR_lblServiceReportDtID"), Label)
                    SR_txtServiceReportDtID.Text = _SR_lblServiceReportDtID.Text.Trim
                    _deleteServiceReportDt()
                    SetDataGrid(Common.Constants.ReportTypePanelID.ServiceReport_PanelID)
            End Select
        End Sub

        Private Sub SR_btnSaveServiceReportDt_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SR_btnSaveServiceReportDt.Click
            _updateServiceReportDt()
        End Sub
#End Region
...
#Region " Thorough Visual Inspection Report "
        ...
        Private Sub TVI_rbtnlImage_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles TVI_rbtnlImage.SelectedIndexChanged
...
#Region " Private Functions "
        ...
        Private Sub SetDataGridReportTypeInProject()
            Dim oPRT As New Common.BussinessRules.ProjectReportType
            oPRT.ProjectID = txtProjectID.Text.Trim
            grdReportTypeRemove.DataSource = oPRT.GetReportTypeByProjectID
            grdReportTypeRemove.DataBind()
            oPRT.Dispose()
            oPRT = Nothing
        End Sub

        Private Sub SetDataGridReportTypeNotInProject()
            Dim oPRT As New Common.BussinessRules.ProjectReportType
            oPRT.ProjectID = txtProjectID.Text.Trim
            grdReportTypeAdd.DataSource = oPRT.SelectReportTypeNotInProjectReportTypeByProjectID
            grdReportTypeAdd.DataBind()
            oPRT.Dispose()
            oPRT = Nothing
        End Sub
        ...
        Private Sub SetDataGridProjectFile()
            ...
            grdSharedProjectFile.DataSource = dt.DefaultView
            grdSharedProjectFile.DataBind()

            br.Dispose()
            br = Nothing

            pnlProjectFile.Visible = dt.Rows.Count > 0
        End Sub
        ...
        Private Sub SetDropDownListItems()
            ...
            commonFunction.SetDDL_Table(IT_ddlVBI, "CommonCode", Common.Constants.GroupCode.InspectionTallyRemark_SCode)
        ...
        Private Sub SetRadioButtonListItems()
            ...
            Select Case TVI_ddlTVIType.SelectedValue.Trim
                Case Common.Constants.ReportTypeCodeThoroughVisualType.Sling
                    commonFunction.SetRBTNL_Table(TVI_rbtnlImage, "CommonCode", Common.Constants.GroupCode.TVISlingPic_SCode)
                Case Common.Constants.ReportTypeCodeThoroughVisualType.Shackle
        ...
        Private Sub PrepareScreen(ByVal _VisiblePanelID As String, ByVal _isAfterInsert As Boolean, Optional ByVal _isNew As Boolean = True)
            ...
            Select Case _VisiblePanelID
                ...
                Case Common.Constants.ReportTypePanelID.TimeSheet_PanelID
                    TS_ddlResourceRole.SelectedIndex = 0
                    TS_txtResourceName.Text = String.Empty
                    Dim oBR As New Common.BussinessRules.ProjectHd
                    oBR.projectID = txtProjectID.Text.Trim
                    oBR.SelectOne()
                ...
                Case Common.Constants.ReportTypePanelID.DailyProgressReport_PanelID
                    ...
                    If _isNew = True Then
                        ...
                        DPR_txtCustomerPICName.Text = String.Empty
                        DPR_txtCustomerPICTitle.Text = String.Empty
                    End If
                ...
                Case Common.Constants.ReportTypePanelID.DailyProgressReportMPI_PanelID
                    ...
                    If _isNew = True Then
                        ...
                        DIR_txtCustomerPICName.Text = String.Empty
                        DIR_txtCustomerPICTitle.Text = String.Empty
                    End If
                ...
                Case Common.Constants.ReportTypePanelID.DrillPipeInspectionReport_PanelID
                    ...
                    If _isNew = True Then
                        ...
                        DP_chkIsBodBent.Checked = False
                        DP_chkIsPinHB.Checked = False
                        DP_chkIsBoxHB.Checked = False
                        DP_chkIsPinReface.Checked = False
                        DP_chkIsBoxReface.Checked = False
                ...
                Case Common.Constants.ReportTypePanelID.ServiceReport_PanelID
                    ...
                    SR_txtServiceReportDtID.Text = String.Empty
                    SR_txtNTName.Text = String.Empty
                    SR_txtNTSerialNo.Text = String.Empty
                    SR_txtNTQty.Text = "0"
                    SR_txtNTUOM.Text = String.Empty
                    SR_txtNTDimension.Text = String.Empty
                    SR_txtNTResult.Text = String.Empty

                    SR_txtCustomerPICName.Text = String.Empty
                    SR_txtCustomerPICTitle.Text = String.Empty
                ...
                Case Common.Constants.ReportTypePanelID.CertificateOfInspection_PanelID
                    ...
                    COI_txtActualLoadTest.Text = "0"
                    COI_txtActualLoadTestUOM.Text = "KG"
                ...
                Case Common.Constants.ReportTypePanelID.InspectionTallyReport_PanelID
                    ...
                    Else
                        If _isNew Then
                            ...
                            IT_ddlVBI.SelectedIndex = 0
                            IT_txtRWT.Text = String.Empty
                            IT_ddlVTIPin.SelectedIndex = 0
                            IT_ddlVTIBox.SelectedIndex = 0
                            IT_ddlFLD.SelectedIndex = 0
        ...
        Private Function GetPic(ByVal imgType As String, ByVal ID As String) As String
            Dim strURL As String = String.Empty
            strURL = UrlBase + "/secure/GetImage.aspx?imgType=" + imgType.Trim + "&cn=" + ID.Trim
            Return strURL.Trim
        End Function
#End Region
                ...
                Case Common.Constants.ReportTypePanelID.DailyProgressReport_PanelID
                    ...
                    With oHd
                        ...
                        If .SelectOne.Rows.Count > 0 Then
                            ...
                            DPR_txtCustomerPICName.Text = .customerPICName.Trim
                            DPR_txtCustomerPICTitle.Text = .customerPICTitle.Trim
                            isNew = False
                        Else
                            PrepareScreen(_VisiblePanelID.Trim, False)
                            isNew = True
                ...
                Case Common.Constants.ReportTypePanelID.DailyProgressReportMPI_PanelID
                    ...
                    With oHd
                        ...
                        If .SelectOne.Rows.Count > 0 Then
                            ...
                            DIR_txtCustomerPICName.Text = .customerPICName.Trim
                            DIR_txtCustomerPICTitle.Text = .customerPICTitle.Trim
                            isNew = False
                        Else
                            PrepareScreen(_VisiblePanelID.Trim, False)
                            isNew = True
                ...
                Case Common.Constants.ReportTypePanelID.DrillPipeInspectionReport_PanelID
                    ...
                    With oDt
                        ...
                        If .SelectOne.Rows.Count > 0 Then
                            ...
                            DP_chkIsBodBent.Checked = .isBodBent
                            DP_chkIsPinHB.Checked = .isPinHB
                            DP_chkIsBoxHB.Checked = .isBoxHB
                            DP_chkIsPinReface.Checked = .isPinReface
                            DP_chkIsBoxReface.Checked = .isBoxReface
                        Else
                ...
                Case Common.Constants.ReportTypePanelID.ServiceReport_PanelID
                    ...
                    With oSR
                        ...
                        If .SelectOne.Rows.Count > 0 Then
                            ...
                            SR_txtCustomerPICName.Text = .customerPICName.Trim
                            SR_txtCustomerPICTitle.Text = .customerPICTitle.Trim
                            commonFunction.Focus(Me, SR_ddlServiceReportFor.ClientID)
                        Else
                ...
                Case Common.Constants.ReportTypePanelID.CertificateOfInspection_PanelID
                    ...
                    With oBR
                        ...
                        If .SelectOne.Rows.Count > 0 Then
                            ...
                            COI_txtActualLoadTest.Text = .actualLoadTest.ToString.Trim
                            COI_txtActualLoadTestUOM.Text = .actualLoadTestUOM.Trim
                        Else
                            PrepareScreen(_VisiblePanelID, False)
                        End If
                    End With
                ...
                Case Common.Constants.ReportTypePanelID.ThoroughVisualInspectionReport_PanelID
                    ...
                    With oTVI
                        ...
                        If .SelectOne.Rows.Count > 0 Then
                            ...
                            If .TVIImageSCode.Trim.Length > 0 Then TVI_rbtnlImage.SelectedValue = .TVIImageSCode.Trim
                            Select Case TVI_ddlTVIType.SelectedValue.Trim
                                Case Common.Constants.ReportTypeCodeThoroughVisualType.Sling
                                    TVI_imgFilePic.ImageUrl = GetPic(Common.Constants.GetImageType.GetImage_CommonCodeFilePic.Trim, Common.Constants.GroupCode.TVISlingPic_SCode.Trim + "|" + TVI_rbtnlImage.SelectedValue.Trim)
                                Case Common.Constants.ReportTypeCodeThoroughVisualType.Shackle
                ...
                Case Common.Constants.ReportTypePanelID.InspectionTallyReport_PanelID
                    ...
                    With oDt
                        ...
                        If .SelectOne.Rows.Count > 0 Then
                            ...
                            commonFunction.SelectListItem(IT_ddlVBI, .VBI.Trim)
                            IT_txtRWT.Text = .RWT.Trim
                            commonFunction.SelectListItem(IT_ddlVTIPin, .VTIPin.Trim)
                            commonFunction.SelectListItem(IT_ddlVTIBox, .VTIBox.Trim)
                            commonFunction.SelectListItem(IT_ddlFLD, .FLD.Trim)                            
            ...
            Select Case _VisiblePanelID
                                ...
                                For Each lvwItem As ListViewItem In lvwTimeSheet.Items
                                    ...
                                    For Each repItem As RepeaterItem In _repDateInMonthDt.Items
                                        ...
                                        If TS_lblDateInMonthDt.Text.Trim = TS_lblDateInMonthHd.Text.Trim Then
                                            ...
                                            .projectResourceID = TS_lblProjectResourceID.Text.Trim
                                            .reportDate = TS_calReportDate.selectedDate
                                            ...
                                            .remarks = ""
                                            .customerPICName = TS_txtCustomerPICName.Text.Trim
                                            .customerPICTitle = TS_txtCustomerPICTitle.Text.Trim
                                            .userIDinsert = MyBase.LoggedOnUserID.Trim
                                            .userIDupdate = MyBase.LoggedOnUserID.Trim
                ...
                Case Common.Constants.ReportTypePanelID.DrillPipeInspectionReport_PanelID
                    ...
                    With oDt
                        ...
                        .isBodBent = DP_chkIsBodBent.Checked
                        .isPinHB = DP_chkIsPinHB.Checked
                        .isBoxHB = DP_chkIsBoxHB.Checked
                        .isPinReface = DP_chkIsPinReface.Checked
                        .isBoxReface = DP_chkIsBoxReface.Checked
                        .userIDinsert = MyBase.LoggedOnUserID
                        .userIDupdate = MyBase.LoggedOnUserID
                        If isNew Then
                ...
                Case Common.Constants.ReportTypePanelID.ServiceReport_PanelID
                    ...
                    With oBR
                        ...
                        .customerPICName = SR_txtCustomerPICName.Text.Trim
                        .customerPICTitle = SR_txtCustomerPICTitle.Text.Trim
                        .userIDinsert = MyBase.LoggedOnUserID
                        .userIDupdate = MyBase.LoggedOnUserID
                        ...
                        If isSucceed Then
                            ...
                            With oSRDt
                                ...
                                End If
                                .serviceReportID = SR_txtServiceReportID.Text.Trim
                                .ntName = SR_txtNTName.Text.Trim
                                .ntSerialNo = SR_txtNTSerialNo.Text.Trim
                                .ntQty = CDec(IIf(IsNumeric(SR_txtNTQty.Text.Trim), SR_txtNTQty.Text.Trim, "0").ToString.Trim)
                                .ntUOM = SR_txtNTUOM.Text.Trim
                                .ntDimension = SR_txtNTDimension.Text.Trim
                                .ntResult = SR_txtNTResult.Text.Trim
                                .userIDinsert = MyBase.LoggedOnUserID.Trim
                                .userIDupdate = MyBase.LoggedOnUserID.Trim
                                ...
                                If isNew Then
                                    If .Insert() Then
                                        SR_txtServiceReportDtID.Text = String.Empty
                                        commonFunction.Focus(Me, SR_txtNTName.ClientID)
                                    End If
                                Else
                                    If .Update() Then
                                        SR_txtServiceReportDtID.Text = String.Empty
                ...
                Case Common.Constants.ReportTypePanelID.ThoroughVisualInspectionReport_PanelID
                    ...
                    With oHd
                        ...
                        .TVIImageSCode = TVI_rbtnlImage.SelectedValue.Trim
                ...
                Case Common.Constants.ReportTypePanelID.InspectionTallyReport_PanelID
                    ...
                    If IT_txtPipeNo.Text.Trim.Length > 0 Then
                        ...
                        With oDt
                            ...
                            .VBI = IT_ddlVBI.SelectedValue.Trim
                            ...
                            .VTIPin = IT_ddlVTIPin.SelectedValue.Trim
                            .VTIBox = IT_ddlVTIBox.SelectedValue.Trim
                            .FLD = IT_ddlFLD.SelectedValue.Trim
...
#Region " C,R,U,D for Project Report Type "
        Private Sub _updateProjectReportType()
            If txtProjectCode.Text.Trim.Length = 0 Then
                commonFunction.MsgBox(Me, "Please select Project first.")
                Exit Sub
            End If

            Dim oPr As New Common.BussinessRules.ProjectReportType
            With oPr
                For Each item As DataGridItem In grdReportTypeAdd.Items
                    Dim _chkSelect As CheckBox = CType(item.FindControl("_chkSelect"), CheckBox)
                    Dim _lblReportTypeID As Label = CType(item.FindControl("_lblReportTypeID"), Label)
                    .ProjectID = txtProjectID.Text.Trim
                    .ReportTypeID = _lblReportTypeID.Text.Trim
                    .UserIDInsert = MyBase.LoggedOnUserID
                    .UserIDPrepare = MyBase.LoggedOnUserID
                    If _chkSelect.Checked Then .Insert()
                Next
            End With
            oPr.Dispose()
            oPr = Nothing
        ...
        Private Sub _deleteProjectReportType()
            If txtProjectCode.Text.Trim.Length = 0 Then
                commonFunction.MsgBox(Me, "Please select Project first.")
                Exit Sub
            End If
            ...
            Dim oPr As New Common.BussinessRules.ProjectReportType
            With oPr
                For Each item As DataGridItem In grdReportTypeRemove.Items
                    Dim _chkSelect As CheckBox = CType(item.FindControl("_chkSelect"), CheckBox)
                    Dim _lblProjectReportTypeID As Label = CType(item.FindControl("_lblProjectReportTypeID"), Label)
                    .ProjectReportTypeID = _lblProjectReportTypeID.Text.Trim
                    If _chkSelect.Checked Then .Delete()
                Next
            End With
            oPr.Dispose()
            oPr = Nothing
...
#Region " C,R,U,D for Drill Pipe Inspection Report "
        ...
        Private Sub _openCaptionTemplateDrillPipe()
            ...
            With oCap
                ...
                End If
                DP_txtPin001Value.Enabled = DP_lblPin001Caption.Text.Trim.Length > 0
                ...
                End If
                DP_txtPin002Value.Enabled = DP_lblPin002Caption.Text.Trim.Length > 0
                ...
                End If
                DP_txtPin003Value.Enabled = DP_lblPin003Caption.Text.Trim.Length > 0
                ...
                End If
                DP_txtPin004Value.Enabled = DP_lblPin004Caption.Text.Trim.Length > 0
                ...
                End If
                DP_txtPin005Value.Enabled = DP_lblPin005Caption.Text.Trim.Length > 0
                ...
                End If
                DP_txtPin006Value.Enabled = DP_lblPin006Caption.Text.Trim.Length > 0
                ...
                End If
                DP_txtPin007Value.Enabled = DP_lblPin007Caption.Text.Trim.Length > 0
                ...
                End If
                DP_txtPin008Value.Enabled = DP_lblPin008Caption.Text.Trim.Length > 0
                ...
                End If
                DP_txtPin009Value.Enabled = DP_lblPin009Caption.Text.Trim.Length > 0
                ...
                End If
                DP_txtPin010Value.Enabled = DP_lblPin010Caption.Text.Trim.Length > 0
                ...
                End If
                DP_txtPin011Value.Enabled = DP_lblPin011Caption.Text.Trim.Length > 0
                ...
                End If
                DP_txtPin012Value.Enabled = DP_lblPin012Caption.Text.Trim.Length > 0
                ...
                End If
                DP_txtPin013Value.Enabled = DP_lblPin013Caption.Text.Trim.Length > 0
                ...
                End If
                DP_txtBox001Value.Enabled = DP_lblBox001Caption.Text.Trim.Length > 0
                ...
                End If
                DP_txtBox002Value.Enabled = DP_lblBox002Caption.Text.Trim.Length > 0
                ...
                End If
                DP_txtBox003Value.Enabled = DP_lblBox003Caption.Text.Trim.Length > 0
                ...
                End If
                DP_txtBox004Value.Enabled = DP_lblBox004Caption.Text.Trim.Length > 0
                ...
                End If
                DP_txtBox005Value.Enabled = DP_lblBox005Caption.Text.Trim.Length > 0
                ...
                End If
                DP_txtBox006Value.Enabled = DP_lblBox006Caption.Text.Trim.Length > 0
                ...
                End If
                DP_txtBox007Value.Enabled = DP_lblBox007Caption.Text.Trim.Length > 0
                ...
                End If
                DP_txtBox008Value.Enabled = DP_lblBox008Caption.Text.Trim.Length > 0
                ...
                End If
                DP_txtBox009Value.Enabled = DP_lblBox009Caption.Text.Trim.Length > 0
                ...
                End If
                DP_txtBox010Value.Enabled = DP_lblBox010Caption.Text.Trim.Length > 0
                ...
                End If
                DP_txtBox011Value.Enabled = DP_lblBox011Caption.Text.Trim.Length > 0
            End With
            oCap.Dispose()
            oCap = Nothing
        End Sub
...
#Region " C,R,U,D for Service Report "
        Private Sub _openServiceReportDt()
            Dim oSRDt As New Common.BussinessRules.ServiceReportDt
            With oSRDt
                .serviceReportDtID = SR_txtServiceReportDtID.Text.Trim
                If .SelectOne.Rows.Count > 0 Then
                    SR_txtNTName.Text = .ntName.Trim
                    SR_txtNTSerialNo.Text = .ntSerialNo.Trim
                    SR_txtNTQty.Text = .ntQty.ToString.Trim
                    SR_txtNTUOM.Text = .ntUOM.Trim
                    SR_txtNTDimension.Text = .ntDimension.Trim
                    SR_txtNTResult.Text = .ntResult.Trim
                Else
                    SR_txtNTName.Text = String.Empty
                    SR_txtNTSerialNo.Text = String.Empty
                    SR_txtNTQty.Text = "0"
        ...
        Private Sub _updateServiceReportDt()
        ...
        Private Sub _deleteServiceReportDt()
            Dim oSRDt As New Common.BussinessRules.ServiceReportDt
            With oSRDt
                .serviceReportDtID = SR_txtServiceReportDtID.Text.Trim
                If .Delete() Then
...
#Region " C,R,U,D for Timesheet "
        Private Sub _openCustomerTimesheet()
            Dim oBR As New Common.BussinessRules.TimeSheet
            With oBR
                If .SelectCustomerPICByMonthYear(CInt(TS_ddlYear.SelectedValue), CInt(TS_ddlMonth.SelectedValue)).Rows.Count > 0 Then
                    TS_txtCustomerPICName.Text = .customerPICName.Trim
                    TS_txtCustomerPICTitle.Text = .customerPICTitle.Trim
                    TS_calReportDate.selectedDate = .reportDate
                Else
                    TS_txtCustomerPICName.Text = String.Empty
                    TS_txtCustomerPICTitle.Text = String.Empty
                    TS_calReportDate.selectedDate = Date.Today
                End If
            End With
            oBR.Dispose()
            oBR = Nothing
        ...
        Private Sub _insertPerson()
            If TS_txtResourceName.Text.Trim.Length = 0 Then
                commonFunction.MsgBox(Me, Common.Constants.MessageBoxText.Validate_ResourceNameCannotEmpty)
                commonFunction.Focus(Me, TS_txtResourceName.ClientID)
                Exit Sub
            End If
            Dim oPerson As New Common.BussinessRules.Person
            With oPerson
                .Salutation = String.Empty
                .FirstName = TS_txtResourceName.Text.Trim
                .MiddleName = String.Empty
                .LastName = String.Empty
                .AcademicTitle = String.Empty
                .SexSCode = String.Empty
                .GenderSCode = String.Empty
                .ReligionSCode = String.Empty
                .NationalitySCode = String.Empty
                ...
                .userIDinsert = MyBase.LoggedOnUserID
                .userIDupdate = MyBase.LoggedOnUserID
                If .Insert() Then TS_txtPersonID.Text = .PersonID.Trim
            End With
            oPerson.Dispose()
            oPerson = Nothing
        End Sub

        Private Sub _insertResource()
            _insertPerson()
            If TS_txtPersonID.Text.Trim.Length > 0 Then
                Dim oRsrc As New Common.BussinessRules.Resource
                With oRsrc
                    .resourceCode = String.Empty
                    .resourceTypeSCode = TS_ddlResourceRole.SelectedValue
                    .resourceJobTitle = String.Empty
                    .personID = TS_txtPersonID.Text.Trim
                    .userID = String.Empty
                    .workingSDate = Date.Today
                    .workingEDate = Date.Today
                    .isActive = False
                    .isAdditional = True
                    .userIDinsert = MyBase.LoggedOnUserID
                    .userIDupdate = MyBase.LoggedOnUserID
                    If .Insert() Then
                        ...
                        oPr.ResourceID = .resourceID.Trim
                        oPr.ResourceRoleSCode = TS_ddlResourceRole.SelectedValue.Trim
                        oPr.ResourceSignatureID = String.Empty
                        oPr.UserIDInsert = MyBase.LoggedOnUserID.Trim
                        oPr.UserIDUpdate = MyBase.LoggedOnUserID.Trim
                        oPr.Insert()
                        oPr.Dispose()
                        oPr = Nothing

                        TS_txtResourceName.Text = String.Empty
                        TS_txtPersonID.Text = String.Empty
