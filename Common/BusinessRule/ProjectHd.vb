...
#Region " Class Member Declarations "
        ...
        Private _totalWorkOrder, _totalItemInspected, _totalItemAccepted, _totalItemNeedRepair, _totalItemClass2, _totalItemRejected As Decimal
#End Region
...
#Region " C,R,U,D "
        Public Overrides Function Insert() As Boolean
            ...
            Dim strProjectCode As String = ID.GenerateIDNumber("ProjectHd", "ProjectCode", Common.Constants.IDPrefix.WorkRequestPrefix, "", "M", "workOrderDate", Year(_workOrderDate).ToString.Trim + (Right("0" + Month(_workOrderDate).ToString.Trim, 2)) + (Right("0" + Day(_workOrderDate).ToString.Trim, 2)))
        ...
        Public Function GetTotalInspectionByCustomer(ByVal strCustomerID As String, ByVal startDate As Date, ByVal endDate As Date, ByVal strProductID As String) As DataTable
            ...
            Try
                ...
                If toReturn.Rows.Count > 0 Then
                    ...
                    _totalItemClass2 = CType(toReturn.Rows(0)("totalItemClass2"), Decimal)
...
#Region " Customer Information "
        ...
        Public Property [totalItemClass2]() As Decimal
            Get
                Return _totalItemClass2
            End Get
            Set(ByVal Value As Decimal)
                _totalItemClass2 = Value
            End Set
        End Property
